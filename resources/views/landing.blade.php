    ...
    <div class="container">
        ...
        <div class="main-features mt-5 text-center">
            <div class="row">
                <div class="col">
                    <h4>Privacy</h5>
                        <h5>With Boukly you can mark your bookmarks as private and they will be hidden in your dashboard
                            untill you provide your password.</h5>
                </div>
                <div class="col">
                    <h4>Cloud</h5>
                        <h5>Boukly keeps you bookmarks stored securely on the cloud so you will never have to lose them
